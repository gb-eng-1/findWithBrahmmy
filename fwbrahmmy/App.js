      ...
      {isLoggedIn ? (
        <ScrollView style={styles.profileContainer}>
          <View style={styles.welcomeContainer}>
            <Image source={userData.profilePicture ? { uri: userData.profilePicture } : require('./assets/pfp.png')} style={styles.profilePicture} />
...
const styles = StyleSheet.create({
  ...
  welcomeContainer: {
    alignItems: 'center', backgroundColor: '#e8e6e6', borderRadius: 15,
    padding: 10, marginBottom: 20, shadowColor: '#000',
  ...
  infoText: {
    fontSize: 16, marginBottom: 10, color: '#000'
  },
  input: {
  ...
  logoutButton: {
    backgroundColor: '#f44336', padding: 10, borderRadius: 5,
    marginTop: 10
  },
  buttonText: {
